...
def download_season(year: int, start_date: str, end_date: str) -> pd.DataFrame:
    """
    Baja todos los pitches de una temporada usando pybaseball.statcast().
    pybaseball internamente hace requests en bloques de 5 días para no
    sobrecargar Baseball Savant.
    """
    print(f"\n{'=' * 60}")
